...
export default function QuiSection() {
  ...
  return (
    <section style={{ padding:'72px 40px', background:'var(--bg)', borderTop:'3px solid var(--gold)' }}>
      <div className="section-wrap">

        <div ref={titleRef} className="reveal" style={{ marginBottom:'32px' }}>
          <div className="eyebrow"><div className="eyebrow-line"/><span className="eyebrow-text">Notre histoire</span></div>
          <h2 style={{ fontFamily:'var(--font-d)', fontSize:'clamp(26px,3.5vw,38px)', fontWeight:300, color:'var(--text-1)', lineHeight:1.15 }}>
            Qui sommes-nous ?
          </h2>
        </div>
        ...
        <div style={{
          ...
          <div>
            ...
            <div
              ref={statsRef}
              className="stagger"
              style={{ display:'grid', gridTemplateColumns:'repeat(3,1fr)', gap:'1px', background:'var(--cream-3)', marginTop:'28px' }}
            >
              {STATS.map(s => (
