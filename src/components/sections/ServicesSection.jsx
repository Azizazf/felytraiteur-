...
function ServiceCard({ item }) {
  ...
  return (
    ...
    >
      <span style={{
        fontSize: '32px', display: 'block', marginBottom: '12px',
      ...
      <p style={{ fontSize: '10px', color: 'var(--text-2)', lineHeight: 1.65 }}>{item.desc}</p>
      <div style={{
        width: '20px', height: '1px', background: 'var(--gold)',
        margin: '14px auto 0',
        transform: hov ? 'scaleX(2.8)' : 'scaleX(1)',
  ...
  return (
    <section style={{ padding:'72px 40px', background:'var(--bg)', borderTop:'1px solid var(--cream-3)' }}>
      <div className="section-wrap">
        ...
        <div ref={gridRef} className="stagger" style={{ display:'grid', gridTemplateColumns:'repeat(3,1fr)', gap:'12px' }}>
